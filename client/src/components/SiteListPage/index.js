                    ...
                    <table className="table">
                        <thead>
                            <tr>
                                ...
                                <th scope="col">
                                    <svg onClick={addSite} width="1em" height="1em" viewBox="0 0 16 16" className="bi bi-plus-square" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                            ...
                            {sites.map((site, index) =>
                                (
                                    <tr key={index}>
                                        ...
                                        <td>{site.siteName}</td>
                                        <td>
                                            <button type="button" onClick={updateSiteDetails} className="btn btn-success mr-1">
                                            ...
                                            <button type="button" onClick={deleteSite} className="btn btn-danger">
